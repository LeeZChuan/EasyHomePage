  ...
  <div class="jn-pricing mt-5 position-relative" id="Pricing">
    ...
    <div class="row mt-5 mx-0 jn-pricing-row px-4" v-if="loaded">
      <div
        ...
        :key="file"
        class="col-mb-4 col-xl-4 col-xxl-4 col-12 mb-5"
      >
        <div class="card jn-card mb-4 position-relative jn-animate-card">
          <div
            class="jn-plan-title"
            :class="{
              'bg-primary': index % 3 === 0,
              'bg-success': index % 3 === 1,
              'bg-purple': index % 3 === 2,
            }"
          >
            <h5 class="card-title">{{ file.attributes.Title }}</h5>
            <h6 class="card-subtitle mb-2 mb-4 opacity-50">
              {{ file.attributes.Subtitle }}
            </h6>
          </div>
          <div class="card-body">
            <div class="jn-plan-detail">
              <ul class="list-group list-group-flush">
                <li
                  v-for="includes in file.attributes.Includes"
                ...
                <li
                  v-for="excludes in file.attributes.Excludes"
                  class="list-group-item border-0"
                >
            ...
            <div class="jn-plan-buy row m-3">
              <button
                ...
                @click="showToast"
                :class="{
                  'btn-primary': index % 3 === 0,
                  'btn-success': index % 3 === 1,
                  'btn-purple': index % 3 === 2,
                }"
              >
  ...
  <div class="toast-container p-3 jn-toast">
    ...
    >
      <div class="toast-header">
        <strong class="me-auto" :class="alert.alertStyle">{{
          alert.alertTitle
        }}</strong>
        <button
          type="button"
