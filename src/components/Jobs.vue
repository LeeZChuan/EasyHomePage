  ...
  <div class="jn-jobs mt-5 position-relative" id="Jobs">
    ...
    <div class="row justify-content-evenly mt-5 mx-0">
      ...
      <div v-if="loaded" class="jn-right-panel col-md-7 col-12">
        ...
        >
          ...
          >
            <button
              ...
              :id="'pills-' + file.attributes.id + '-tab'"
              type="button"
              role="tab"
        ...
        <div
          class="tab-content jn-tab-content card jn-card mb-5"
          id="pills-tabContent"
        ...
        >
          <div
            ...
            v-for="(file, index) in markdownFiles"
            :key="'tab-pane-' + file.attributes.id"
            :id="'jobs-' + file.attributes.id"
            role="tabpanel"
            :aria-labelledby="'pills-' + file.attributes.id + '-tab'"
            tabindex="0"
          >
            <div class="fs-4">
              <span class="fw-bold">{{ file.attributes.title }}</span> @
              <a
                class="text-decoration-none link-purple"
